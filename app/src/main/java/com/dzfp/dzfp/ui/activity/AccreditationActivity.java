...
import com.dzfp.dzfp.ui.util.UploadUtil;
...
public class AccreditationActivity extends BaseActivity {
    ...
    int haveImg = 0;//0为未上传，1为上传中，2为上传完成
    int type;
    TextView title;
    ...
    private void listern() {
        ...
        bing.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (haveImg == 0) {
                    DialogHb.showdialog(AccreditationActivity.this, "请上传相关证件图片");
                } else if (haveImg == 1) {
                    DialogHb.showdialog(AccreditationActivity.this, "图片正在上传中");
                } else {
                    new Thread(new Runnable() {
                        @Override
                        public void run() {
