...
import com.dzfp.dzfp.ui.adapter.ComListAdapter;
...
public class AuthComActivity extends BaseActivity {
            ...
            switch (view.getId()) {
                case R.id.bt_bing_current:
                    if (name.getText().toString().equals("")) {
                        DialogHb.showdialog(AuthComActivity.this, "请填写公司详细信息");
                    } else {
                ...
                case R.id.findcom_btn:
                    if (name.getText().toString().equals("")) {
                        Toast.makeText(AuthComActivity.this, "请输入公司名称", Toast.LENGTH_SHORT).show();
                    } else {
                        findcom.setText("查询中");
                ...
                case R.id.findsh_btn:
                    if (shuihao.getText().toString().equals("")) {
                        Toast.makeText(AuthComActivity.this, "请输入公司税号", Toast.LENGTH_SHORT).show();
                    } else {
                        findsh.setText("查询中");
