...
import com.dzfp.dzfp.databinding.DescribeAtyBinding;
 ...
 */
public class DescribeAty extends BaseActivity implements View.OnClickListener {
    ...
    private void init() {
        ...
        mDescribeAtyBinding.setOnclick(this);
    }
