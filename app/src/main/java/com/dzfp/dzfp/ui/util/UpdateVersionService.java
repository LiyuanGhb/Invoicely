...
public class UpdateVersionService {
    ...
    boolean updata;
    Handler handler = new Handler() {// 跟心ui
        @Override
    ...
    Handler handlers = new Handler() {
        ...
        public void handleMessage(Message msg) {
            super.handleMessage(msg);
            updata= (boolean) msg.obj;
            Log.e("jinlaile",updata+"");
            if (updata) {
                showUpdateVersionDialog();// 显示提示对话框
            } else {
                if (chose == 1) {
                    DialogHb.showdialog(context, "当前已是最新版本，版本号1.9");
                }
            }
        }
    };
    ...
    private void showUpdateVersionDialog() {
        ...
        builder.setNegativeButton("稍后更新", new OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                if (CustomApplication.mustUp) {
                    Log.e("mp",CustomApplication.mustUp+"");
                    DialogHb.showdialog(context, "新版本有重要内容，不更新将影响您的正常使用");
                }
            }
        });
                ...
                new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (null != hashMap) {
                            ...
                            Log.e("hasmap", hashMap.toString());
                            String must = hashMap.get("must");
                            if ("1".equals(must)) {
                                CustomApplication.mustUp = true;
                            } else {
                                CustomApplication.mustUp = false;
                            }
    ...
    private int getVersionCode(Context context2) {
        ...
        try {
            ...
            versionCode = context.getPackageManager().getPackageInfo("com.dzfp.dzfp", 0).versionCode;
    ...
    public void uninstallAPK() {
        Uri packageURI = Uri.parse("com.dzfp.dzfp");
